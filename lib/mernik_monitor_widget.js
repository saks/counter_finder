...
function noCountersFound() {
	panel.postMessage([ 'updateCountersHTML', '<ul><li class="disabled counter"><span class="icon no_counter_found"></span><span class="name">no counters found</span></li></ul>' ]);
}
...
exports.noCountersFound = noCountersFound;
exports.panel           = panel;
